...
class _LoginViewState extends State<LoginView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          icon: Icon(CupertinoIcons.back, size: 28.w,color: Colors.black.withOpacity(.7),),
          onPressed: () {},
        ),
      ),
        ...
        physics: const NeverScrollableScrollPhysics(),
         slivers: [
           SliverFillRemaining(
             hasScrollBody: false,
             child: Padding(
               padding:  EdgeInsets.only(left: 24.w,right: 24.w,bottom: 10.h,top: 18.h),
               child: Form(
                 key: _formKey,
                 child: Column(
                   children: [
                     ...
                     AppField(labelText: "Enter your email",
                       height: 67,
