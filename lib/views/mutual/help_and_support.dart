...
class HelpAndSupportView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Padding(
            padding:
                EdgeInsetsDirectional.only(top: 36.w, start: 24.w, end: 24.w),
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Row(children: [
                    Text("Objective", style: TextStyles.poppins16BlackSemiBold),
                  ]),
                  SizedBox(height: 16.h),
                  const _Item(hintText: "the title"),
                  SizedBox(height: 32.h),
                  Row(children: [
                    Text("Email", style: TextStyles.poppins16BlackSemiBold),
                  ]),
                  SizedBox(height: 16.h),
